import React, { useState } from 'react' //useState - é um Hook (gancho, facilitador) para gerenciar os estados
import {
  SafeAreaView,
  View,
  Text,
...
export default function App() {
  //declarando uma variável que recebe o estado do componente
  //se assemelha aos métodos get() e set() das linguagens orientadas a objetos
  //falando (get), setFalando (set)
  ...
  return (
    <SafeAreaView style={styles.Principal}>
      ...
      {/* Comentário em React */}
      {/* 
        O operador && indica que se o teste lógico for 
        verdadeiro, o componente irá aparecer. Senão,
        não ocorrerá nada. 
      */}
